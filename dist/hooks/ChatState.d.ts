...
export declare const useChatState: (props: {
  ...
  setMessages: import("react").Dispatch<
    import("react").SetStateAction<ChatMessage[]>
  >;
  currentInput: string;
  setCurrentInput: import("react").Dispatch<
    import("react").SetStateAction<string>
  >;
  threadId: string | undefined;
  setThreadId: import("react").Dispatch<
    import("react").SetStateAction<string | undefined>
  >;
  messageId: string | undefined;
  setMessageId: import("react").Dispatch<
    import("react").SetStateAction<string | undefined>
  >;
  traceId: string | undefined;
  setTraceId: import("react").Dispatch<
    import("react").SetStateAction<string | undefined>
  >;
  typing: boolean;
