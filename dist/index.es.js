    ...
    function ea(v, F, Z, le, ke, Oe) {
      {
        ...
        if (_.call(F, "key")) {
          var vt = $(v), We = Object.keys(F).filter(function(Pc) {
            return Pc !== "key";
...
var ao;
const Pl = typeof navigator < "u" && ((ao = navigator == null ? void 0 : navigator.userAgent) != null && ao.includes("Safari")) ? 100 : 1, He = (n, e = Pl) => {
  setTimeout(() => {
    n();
  }, e);
  ...
  const g = ((b) => {
    ...
    const I = ds(b) ? b : void 0, N = (I == null ? void 0 : I.dataTransferMode) ?? void 0, A = y.length === 1 ? y[0] : "stream";
    return N ?? A;
  })(e);
  ((b) => "streamServerComponent" in b ? "server-component" : "text")(e) === "server-component" ? (u = /* @__PURE__ */ new Set(), o = /* @__PURE__ */ new Set(), ((b, y, k, w, I, N, A, T) => new Promise((O, H) => {
    ...
    try {
      const T = y.content, O = ds(k) ? k : void 0, H = O !== void 0, z = Je(), $ = "assistant", P = "complete", W = /* @__PURE__ */ new Date(), ae = "batch";
      let C;
      if (H) {
...
const ys = (n) => x.jsx(Yo, { children: x.jsx(Mu, { ...n }) }), Zo = (n) => {
  ...
  const l = function(T) {
    ...
    if ((D == null ? void 0 : D.responseRenderer) !== void 0) {
      ...
      const S = Lt(P), R = { uid: O, status: "complete", dataTransferMode: z, contentType: $, content: P ? S ? [] : [P] : [], serverComponent: S ? P : void 0, serverResponse: C ? [C] : [] };
      return () => {
    ...
    const O = ue(() => x.jsxs("div", { className: "nlux-comp-chatItem-participantInfo", children: [T.avatar !== void 0 && x.jsx(Zo, { name: T.name, avatar: T.avatar }), x.jsx("span", { className: "nlux-comp-chatItem-participantName", children: T.name })] }), [T.avatar, T.name]);
...
var io;
const Ku = typeof navigator < "u" && ((io = navigator == null ? void 0 : navigator.userAgent) != null && io.includes("Safari")) ? 100 : 1, je = (n, e = Ku) => {
  setTimeout(() => {
    n();
  }, e);
  ...
  return he(() => {
    ...
    d("submitting-prompt");
    const k = r, w = /* @__PURE__ */ new Set(), I = Hn(t) ? t : t.streamServerComponent ? { streamServerComponent: t.streamServerComponent } : { batchText: t.batchText, streamText: t.streamText }, { segment: N, observable: A } = Wu(k, I, b);
    ...
    A.on("userMessageReceived", (O) => {
      ...
      var P;
      const z = f.current.newSegments.filter((W) => W.uid !== N.uid), $ = Yu[O];
  ...
  }(N, T, H, A, O, z, l, k), S = Ce((_) => b(_), [b]), R = Zu({ aiChatProps: n, adapterToUse: P, conversationRef: l, initialSegment: w, newSegments: N, cancelledMessageIds: H, cancelledSegmentIds: T, prompt: E, composerOptions: a, showException: L, setChatSegments: A, setComposerStatus: k, setPrompt: b }), j = ((_, G, se, q, xe, ce) => Ce((re, Re, B) => {
    if (re === "initial" && _) {
      const M = [];
...
Reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import#dynamic_imports`), i("error"), s.onError(l);
    ...
    }, []), a === "idle" || a === "loading" ? null : a === "error" ? (qe("Error loading RSC"), x.jsx(x.Fragment, { children: "Error loading RSC" })) : x.jsx(zc, { fallback: e || null, children: o && x.jsx(o, {}) });
  } };
}, Dh = (n, e, t) => {
...
function vd(n, e) {
  ...
  return new Promise((d, p) => {
    ...
    const y = l ?? window.fetch, k = s ?? Ed;
    async function w() {
      var I;
      h = new AbortController();
      try {
        const N = await y(n, Object.assign(Object.assign({}, c), { headers: m, signal: h.signal }));
        await k(N), await md(N.body, hd(gd((A) => {
          A ? m[Ya] = A : delete m[Ya];
        }, (A) => {
          f = A;
        }, a))), i == null || i(), b(), d();
      } catch (N) {
...
var Xa;
function nc() {
  return Xa || (Xa = 1, process.env.NODE_ENV === "production" ? Tn.exports = xd() : Tn.exports = kd()), Tn.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var dr, ei;
function rc() {
  return ei || (ei = 1, dr = Function.call.bind(Object.prototype.hasOwnProperty)), dr;
}
var pr, ti;
function _d() {
  if (ti) return pr;
...
function Cd() {
  if (ni) return mr;
  ni = 1;
  var n = nc(), e = Sd(), t = js(), r = rc(), s = _d(), a = function() {
  };
...
if (process.env.NODE_ENV !== "production") {
  var Ad = nc(), Id = !0;
  xs.exports = Cd()(Ad.isElement, Id);
} else
  xs.exports = Td()();
var Rd = xs.exports;
const Ne = /* @__PURE__ */ co(Rd);
function Bt(n, e, t, r) {
  function s(a) {
...
function Nd(n) {
  ...
  if (t && !n.type) {
    var r = e.split(".").pop().toLowerCase(), s = Od.get(r);
...
function Dd(n) {
  return Bt(this, void 0, void 0, function() {
    return zt(this, function(e) {
      return Kn(n) && Ld(n.dataTransfer) ? [2, Fd(n.dataTransfer, n.type)] : Pd(n) ? [2, Bd(n)] : Array.isArray(n) && n.every(function(t) {
      ...
      switch (s.label) {
        case 0:
          return n.items ? (t = ks(n.items).filter(function(a) {
            return a.kind === "file";
          }), e !== "drop" ? [2, t] : [4, Promise.all(t.map(Ud))]) : [3, 2];
        case 1:
          return r = s.sent(), [2, ii(sc(r))];
        case 2:
          return [2, ii(ks(n.files).map(function(a) {
            return pn(a);
          }))];
      }
    });
...
function Ud(n) {
  ...
  return e && e.isDirectory ? ac(e) : oi(n);
}
function sc(n) {
  return n.reduce(function(e, t) {
    return ai(ai([], si(e), !1), si(Array.isArray(t) ? sc(t) : [t]), !1);
  }, []);
}
function oi(n) {
  var e = n.getAsFile();
...
function $d(n) {
  return Bt(this, void 0, void 0, function() {
    return zt(this, function(e) {
      return [2, n.isDirectory ? ac(n) : Hd(n)];
    });
  });
}
function ac(n) {
          ...
          return zt(this, function(d) {
            switch (d.label) {
              ...
              case 4:
                return [3, 6];
              case 5:
                c = Promise.all(o.map($d)), s.push(c), a(), d.label = 6;
              case 6:
                return [
                  2
                  /*return*/
...
function ui(n) {
  for (var e = 1; e < arguments.length; e++) {
    var t = arguments[e] != null ? arguments[e] : {};
    e % 2 ? li(Object(t), !0).forEach(function(r) {
      ic(n, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : li(Object(t)).forEach(function(r) {
      Object.defineProperty(n, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return n;
...
var Qd = "file-invalid-type", Xd = "file-too-large", Vd = "file-too-small", Jd = "too-many-files", ep = function(e) {
...
function cc(n, e) {
  var t = n.type === "application/x-moz-file" || jd(n, e);
  return [t, t ? null : ep(e)];
}
function lc(n, e, t) {
  if (St(n.size))
    if (St(e) && St(t)) {
      if (n.size > t) return [!1, di(t)];
      if (n.size < e) return [!1, pi(e)];
    } else {
      if (St(e) && n.size < e) return [!1, pi(e)];
      if (St(t) && n.size > t) return [!1, di(t)];
    }
  return [!0, null];
}
function St(n) {
...
function np(n) {
  ...
  return !a && e.length > 1 || a && i >= 1 && e.length > i ? !1 : e.every(function(u) {
    var l = cc(u, t), c = nn(l, 1), d = c[0], p = lc(u, r, s), m = nn(p, 1), h = m[0], g = o ? o(u) : null;
    return d && h && !g;
  });
}
function Gn(n) {
...
function op(n) {
  if (St(n)) {
    var e = Object.entries(n).filter(function(t) {
      ...
      return uc(s) || (console.warn('Skipped "'.concat(s, '" because it is not a valid MIME type. Check https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types for a list of valid MIME types.')), i = !1), (!Array.isArray(a) || !a.every(dc)) && (console.warn('Skipped "'.concat(s, '" because an invalid file extension was provided.')), i = !1), i;
    }).reduce(function(t, r) {
      var s = nn(r, 2), a = s[0], i = s[1];
      return ui(ui({}, t), {}, ic({}, a, i));
    }, {});
    return [{
...
var dp = ["children"], pp = ["open"], mp = ["refKey", "role", "onKeyDown", "onFocus", "onBlur", "onClick", "onDragEnter", "onDragOver", "onDragLeave", "onDrop"], hp = ["refKey", "onChange", "onClick"];
function gp(n) {
  return yp(n) || bp(n) || pc(n) || fp();
}
function fp() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var qs = /* @__PURE__ */ an(function(n, e) {
  var t = n.children, r = Wn(n, dp), s = hc(r), a = s.open, i = Wn(s, pp);
...
function hc() {
  ...
  he(function() {
    return y && (document.addEventListener("dragover", mi, !1), document.addEventListener("drop", te, !1)), function() {
      y && (document.removeEventListener("dragover", mi), document.removeEventListener("drop", te));
    };
  }, [P, y]), he(function() {
  ...
  var Y = Ce(function(B) {
    ...
    B.preventDefault(), B.persist(), xe(B), ee.current = [].concat(gp(ee.current), [B.target]), An(B) && Promise.resolve(s(B)).then(function(J) {
      if (!(Gn(B) && !N)) {
        var me = J.length, M = me > 0 && np({
          files: J,
          accept: O,
          minSize: i,
          maxSize: a,
    ...
    B.forEach(function(K) {
      var oe = cc(K, O), pe = gr(oe, 2), Me = pe[0], $e = pe[1], ot = lc(K, i, a), tt = gr(ot, 2), ft = tt[0], bt = tt[1], yt = T ? T(K) : null;
      if (Me && ft && !yt)
        me.push(K);
      else {
        var ve = [$e, bt];
    ...
    if (j.current) {
      ...
      window.showOpenFilePicker(B).then(function(J) {
        ...
        lp(J) ? ($(J), D({
          type: "closeDialog"
        })) : up(J) ? (j.current = !1, W.current ? (W.current.value = null, W.current.click()) : Y(new Error("Cannot open the file picker because the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API is not supported and no <input> was provided."))) : Y(J);
      });
      return;
    }
    W.current && (D({
    ...
    return function() {
      var B = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, J = B.refKey, me = J === void 0 ? "ref" : J, M = B.role, K = B.onKeyDown, oe = B.onFocus, pe = B.onBlur, Me = B.onClick, $e = B.onDragEnter, ot = B.onDragOver, tt = B.onDragLeave, ft = B.onDrop, bt = Wn(B, mp);
      return Pe(Pe(Cs({
    ...
    return function() {
      var B = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, J = B.refKey, me = J === void 0 ? "ref" : J, M = B.onChange, K = B.onClick, oe = Wn(B, hp), pe = Cs({
        accept: O,
        multiple: o,
        type: "file",
        style: {
...
const Sp = (n) => /* @__PURE__ */ x.jsx("svg", { ...n, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "size-6", children: /* @__PURE__ */ x.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M5 12h14" }) }), _p = () => /* @__PURE__ */ x.jsxs("svg", { viewBox: "0 0 200 200", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
...
] }), Cp = ({ files: n }) => /* @__PURE__ */ x.jsx(x.Fragment, { children: n.map((e, t) => /* @__PURE__ */ x.jsx("div", { className: "thumbnail m-2", children: /* @__PURE__ */ x.jsx("div", { className: "thumbnailInner", children: /* @__PURE__ */ x.jsx("img", { src: e.preview, alt: e.preview, className: "w-[150px]" }) }) }, t)) }), Tp = ({ files: n, setFiles: e }) => {
  const t = Ce((i) => {
    e((o) => [...o, ...i.map((u) => Object.assign(u, {
      preview: URL.createObjectURL(u)
    }))]);
  }, []), { getRootProps: r, getInputProps: s } = hc({ onDrop: t }), a = (i) => () => {
  ...
  return /* @__PURE__ */ x.jsxs("div", { className: "flex flex-col w-[100%] dropzone border", children: [
    ...
    /* @__PURE__ */ x.jsx("aside", { className: "flex flex-wrap mt-4", children: n.map((i) => /* @__PURE__ */ x.jsxs("div", { className: "relative m-2", children: [
      /* @__PURE__ */ x.jsx("button", { onClick: a(i), className: "absolute top-0 right-0 p-1 bg-red-500 rounded-full text-white", children: /* @__PURE__ */ x.jsx(Sp, { className: "w-4 h-4" }) }),
...
const Ip = /* @__PURE__ */ Ke.forwardRef(Ap);
function Rp({
  title: n,
  titleId: e,
  ...t
...
const Op = /* @__PURE__ */ Ke.forwardRef(Rp);
function Np({
  title: n,
  titleId: e,
  ...t
...
const Mp = /* @__PURE__ */ Ke.forwardRef(Np);
function Dp({
  title: n,
  titleId: e,
  ...t
...
const Lp = /* @__PURE__ */ Ke.forwardRef(Dp);
function gc(n) {
  return n instanceof Map ? n.clear = n.delete = n.set = function() {
    ...
    (r === "object" || r === "function") && !Object.isFrozen(t) && gc(t);
  }), n;
}
class fi {
  /**
...
const Pp = "</span>", bi = (n) => !!n.scope, Bp = (n, { prefix: e }) => {
...
class Ks {
  constructor() {
    this.rootNode = yi(), this.stack = [this.rootNode];
  }
  get top() {
...
class Fp extends Ks {
  ...
  toHTML() {
    return new zp(this, this.options).value();
  }
  finalize() {
...
function Gs(...n) {
  return "(" + (Hp(n).capture ? "" : "?:") + n.map((r) => rn(r)).join("|") + ")";
}
function yc(n) {
...
const Kp = /\b\B/, vc = "[a-zA-Z]\\w*", Ys = "[a-zA-Z_]\\w*", Ec = "\\b\\d+(\\.\\d+)?", wc = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", xc = "\\b(0b[01]+)", Gp = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", Wp = (n = {}) => {
  const e = /^#![ ]*\//;
...
var In = /* @__PURE__ */ Object.freeze({
  ...
  APOS_STRING_MODE: Yp,
  BACKSLASH_ESCAPE: sn,
  BINARY_NUMBER_MODE: nm,
  BINARY_NUMBER_RE: xc,
  COMMENT: Xn,
  C_BLOCK_COMMENT_MODE: Vp,
  C_LINE_COMMENT_MODE: Xp,
  C_NUMBER_MODE: tm,
  C_NUMBER_RE: wc,
  END_SAME_AS_BEGIN: om,
  HASH_COMMENT_MODE: Jp,
  IDENT_RE: vc,
  MATCH_NOTHING_RE: Kp,
  METHOD_GUARD: im,
  NUMBER_MODE: em,
  NUMBER_RE: Ec,
  PHRASAL_WORDS_MODE: Qp,
  QUOTE_STRING_MODE: Zp,
  REGEXP_MODE: rm,
  RE_STARTERS_RE: Gp,
  SHEBANG: Wp,
  TITLE_MODE: sm,
  UNDERSCORE_IDENT_RE: Ys,
  UNDERSCORE_TITLE_MODE: am
});
function cm(n, e) {
...
function um(n, e) {
  e && n.beginKeywords && (n.begin = "\\b(" + n.beginKeywords.split(" ").join("|") + ")(?!\\.)(?=\\b|\\s)", n.__beforeBegin = cm, n.keywords = n.keywords || n.beginKeywords, delete n.beginKeywords, n.relevance === void 0 && (n.relevance = 0));
}
function dm(n, e) {
...
const hm = (n, e) => {
  ...
  Object.keys(n).forEach((r) => {
    delete n[r];
  }), n.keywords = t.keywords, n.begin = At(t.beforeMatch, bc(t.begin)), n.starts = {
    relevance: 0,
    contains: [
...
function bm(n, e) {
  return e ? Number(e) : ym(n) ? 0 : 1;
}
function ym(n) {
  return gm.includes(n.toLowerCase());
}
const vi = {}, _t = (n) => {
  console.error(n);
}, Ei = (n, ...e) => {
  ...
  vi[`${n}/${e}`] || (console.log(`Deprecated as of ${n}. ${e}`), vi[`${n}/${e}`] = !0);
}, Yn = new Error();
function Sc(n, e, { key: t }) {
  let r = 0;
  const s = n[t], a = {}, i = {};
  for (let o = 1; o <= e.length; o++)
    i[o + r] = s[o], a[o + r] = !0, r += yc(e[o - 1]);
...
function vm(n) {
  if (Array.isArray(n.begin)) {
    ...
    Sc(n, n.begin, { key: "beginScope" }), n.begin = Ws(n.begin, { joinWith: "" });
  }
}
function Em(n) {
  if (Array.isArray(n.end)) {
    ...
    Sc(n, n.end, { key: "endScope" }), n.end = Ws(n.end, { joinWith: "" });
  }
}
function wm(n) {
...
function xm(n) {
  wm(n), typeof n.beginScope == "string" && (n.beginScope = { _wrap: n.beginScope }), typeof n.endScope == "string" && (n.endScope = { _wrap: n.endScope }), vm(n), Em(n);
}
function km(n) {
  function e(i, o) {
    return new RegExp(
  ...
  class t {
    ...
    // @ts-ignore
    addRule(o, u) {
      u.position = this.position++, this.matchIndexes[this.matchAt] = u, this.regexes.push([u, o]), this.matchAt += yc(o) + 1;
    }
    compile() {
  ...
  function a(i, o) {
    ...
    let l = null;
    return typeof i.keywords == "object" && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords), l = i.keywords.$pattern, delete i.keywords.$pattern), l = l || /\w+/, i.keywords && (i.keywords = kc(i.keywords, n.case_insensitive)), u.keywordPatternRe = e(l, !0), o && (i.begin || (i.begin = /\B|\b/), u.beginRe = e(u.begin), !i.end && !i.endsWithParent && (i.end = /\B|\b/), i.end && (u.endRe = e(u.end)), u.terminatorEnd = rn(u.end) || "", i.endsWithParent && o.terminatorEnd && (u.terminatorEnd += (i.end ? "|" : "") + o.terminatorEnd)), i.illegal && (u.illegalRe = e(
      /** @type {RegExp | string} */
      i.illegal
    )), i.contains || (i.contains = []), i.contains = [].concat(...i.contains.map(function(c) {
      return Sm(c === "self" ? i : c);
...
function _c(n) {
  return n ? n.endsWithParent || _c(n.starts) : !1;
}
function Sm(n) {
  return n.variants && !n.cachedVariants && (n.cachedVariants = n.variants.map(function(e) {
    return ht(n, { variants: null }, e);
  })), n.cachedVariants ? n.cachedVariants : _c(n) ? ht(n, { starts: n.starts ? ht(n.starts) : null }) : Object.isFrozen(n) ? ht(n) : n;
}
var _m = "11.10.0";
...
const fr = fc, wi = ht, xi = Symbol("nomatch"), Tm = 7, Cc = function(n) {
  ...
  function l(C) {
    ...
    if (D) {
      const S = T(D[1]);
      return S || (Ei(a.replace("{}", D[1])), Ei("Falling back to no-highlight mode for this block.", C)), S ? D[1] : "no-highlight";
    }
  ...
  function d(C, L, D, S) {
    ...
    function X() {
      ...
      for (; K; ) {
        ...
        if (Me) {
          const [$e, ot] = Me;
          if (ce.addText(oe), oe = "", R[pe] = (R[pe] || 0) + 1, R[pe] <= Tm && (Re += ot), $e.startsWith("_"))
            oe += K[0];
          else {
    ...
    function fe(M) {
      const K = M[0], oe = M.rule, pe = new fi(oe), Me = [oe.__beforeBegin, oe["on:begin"]];
      for (const $e of Me)
...
var ge = Am;
ge.registerLanguage("xml", Im());
ge.registerLanguage("bash", Rm());
ge.registerLanguage("c", Om());
ge.registerLanguage("cpp", Nm());
ge.registerLanguage("csharp", Mm());
ge.registerLanguage("css", Dm());
ge.registerLanguage("markdown", Lm());
ge.registerLanguage("diff", Pm());
ge.registerLanguage("ruby", Bm());
ge.registerLanguage("go", zm());
ge.registerLanguage("graphql", Fm());
ge.registerLanguage("ini", Um());
ge.registerLanguage("java", $m());
ge.registerLanguage("javascript", Hm());
ge.registerLanguage("json", jm());
ge.registerLanguage("kotlin", qm());
ge.registerLanguage("less", Km());
ge.registerLanguage("lua", Gm());
ge.registerLanguage("makefile", Wm());
ge.registerLanguage("perl", Ym());
ge.registerLanguage("objectivec", Zm());
ge.registerLanguage("php", Qm());
ge.registerLanguage("php-template", Xm());
ge.registerLanguage("plaintext", Vm());
ge.registerLanguage("python", Jm());
ge.registerLanguage("python-repl", eh());
ge.registerLanguage("r", th());
ge.registerLanguage("rust", nh());
ge.registerLanguage("scss", rh());
ge.registerLanguage("shell", sh());
ge.registerLanguage("sql", ah());
ge.registerLanguage("swift", ih());
ge.registerLanguage("yaml", oh());
ge.registerLanguage("typescript", ch());
ge.registerLanguage("vbnet", lh());
ge.registerLanguage("wasm", uh());
ge.HighlightJS = ge;
ge.default = ge;
var dh = ge;
const Rn = /* @__PURE__ */ co(dh), ph = { js: "javascript", ts: "typescript", jsx: "javascript", tsx: "typescript", html: "xml", html5: "xml", md: "markdown", yml: "yaml", py: "python", rb: "ruby", kt: "kotlin", rs: "rust" }, mh = (() => {
  const n = "dark";
  let e = n;
  for (const [s, a] of Object.entries(ph)) Rn.getLanguage(a) ? Rn.registerAliases(s, { languageName: a }) : typeof (t = `Language "${a}" is not registered to use with highlight.js.`) != "string" ? t && typeof t.toString == "function" ? console.warn(`[nlux] ${t.toString()}`) : console.warn("[nlux]") : console.warn(`[nlux] ${t}`);
  var t;
  const r = (s, a) => {
  ...
  const [e] = Te(n.messages), t = n.advancedOptions || {}, r = t.conversationOptions || {
    layout: "bubbles"
  }, [s, a] = Te([]), { adapter: i, threadId: o, messageId: u } = wd({ ...n, files: s }), { controls: l } = n, [c, d] = Te(/* @__PURE__ */ new Map()), p = (N, A) => {
    ...
    return /* @__PURE__ */ x.jsxs("div", { className: "rounded-lg shadow-sm", children: [
      ...
      /* @__PURE__ */ x.jsx("div", { className: "mt-2", children: O && /* @__PURE__ */ x.jsx(Cp, { files: O }) })
    ] });
  }, h = Ve.memo((N) => {
    const [A, T] = Te(), [O, H] = Te(), z = async ($) => {
      ...
      try {
        const ae = await tc(n), C = n.serverUrl || ec;
    ...
    return /* @__PURE__ */ x.jsxs("div", { className: "", children: [
      N.dataTransferMode === "batch" && /* @__PURE__ */ x.jsx(Xu, { children: N.content }),
      N.dataTransferMode === "stream" && /* @__PURE__ */ x.jsx("div", { className: "p-2 rounded-lg", ref: N.containerRef }),
      /* @__PURE__ */ x.jsxs("div", { className: "flex items-center justify-start space-x-1", children: [
        /* @__PURE__ */ x.jsxs(
          "button",
          {
            ...
            onClick: () => z(1),
            children: [
              A == null && /* @__PURE__ */ x.jsx(Op, { className: "h-4 w-4" }),
              A === 1 && /* @__PURE__ */ x.jsx(Lp, { className: "h-4 w-4 animate-fadeIn" })
            ]
          }
        ),
        /* @__PURE__ */ x.jsxs(
          "button",
          {
            ...
            onClick: () => z(-1),
            children: [
              A == null && /* @__PURE__ */ x.jsx(Ip, { className: "h-4 w-4" }),
              A === -1 && /* @__PURE__ */ x.jsx(Mp, { className: "h-4 w-4 animate-fadeIn" })
            ]
          }
        )
      ] }),
  ...
  return /* @__PURE__ */ x.jsxs("div", { className: "flex flex-col w-[100%] h-full", children: [
    (l == null ? void 0 : l.enableFiles) && /* @__PURE__ */ x.jsx(Tp, { files: s, setFiles: a }),
                ...
                /* @__PURE__ */ x.jsxs("div", { className: "flex gap-2", children: [
                  ...
                  !(c != null && c.hideMaximise) && /* @__PURE__ */ x.jsx(
                    "button",
                    {
                      ...
                      children: m ? /* @__PURE__ */ x.jsx(bh, {}) : /* @__PURE__ */ x.jsx(fh, {})
                    }
                  )
                ] }),
...
export {
  ...
  qa as AiChatUI,
  hh as ChatIcon,
  Fh as FloatingChatWidget,
  ld as ImageDetail,
  Xu as Markdown,
  od as MessageContentType,
  cd as MessageType,
  zh as Widget,
  Ph as createAiContext,
  ud as createInnerMessage,
  Rh as useAiChatApi,
  Dh as useAiContext,
  Lh as useAiTask,
  Oh as useAsBatchAdapter,
  Mh as useAsRscAdapter,
  Nh as useAsStreamAdapter,
  Bh as useDeepCompareEffect
};
