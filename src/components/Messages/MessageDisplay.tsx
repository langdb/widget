...
export const BaseMessageDisplay: React.FC<{ message: string }> = ({ message }) => {
  return <ReactMarkdown
    ...
    components={{
      ...
      ul({ children, ...props }) {
        return <ul {...props} className={`list-disc list-inside ${props.className}`}>{children}</ul>
      },
      ol({ children, ...props }) {
        return <ol {...props} className={`list-decimal list-inside ${props.className}`}>{children}</ol>
      },
