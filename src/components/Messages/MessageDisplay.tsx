...
export const BaseMessageDisplay: React.FC<{ message: string }> = ({
  message,
}) => {
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h1({ children, ...props }) {
          return (
            <h1
              className="font-bold text-3xl pb-[0.3em] border-b border-border "
              {...props}
            >
              {children}
            </h1>
        ...
        h2({ children, ...props }) {
          return (
            <h2
              className="font-bold text-2xl pb-[0.3em] border-b border-border"
              {...props}
            >
              {children}
            </h2>
        ...
        h5({ children, ...props }) {
          return (
            <h5 className="font-bold text-md " {...props}>
              {children}
            </h5>
          );
        },
        ...
        ul({ children, ...props }) {
          return (
            <ul
              {...props}
              className={`list-disc list-inside my-1 ${props.className || ""}`}
            >
              {children}
            </ul>
          );
        ...
        ol({ children, ...props }) {
          return (
            <ol
              {...props}
              className={`list-decimal list-inside my-1 ${props.className || ""}`}
            >
              {children}
            </ol>
          );
        ...
        li({ children, ...props }) {
          return (
            <li
              {...props}
              className={`list-item my-0.5 ${props.className || ""}`}
            >
              {children}
            </li>
          );
        ...
        table({ children, ...props }) {
          return (
            <table className="table-auto my-1 mx-1" {...props}>
              {children}
            </table>
          );
        },
        ...
        th({ children, ...props }) {
          return (
            <th
              className="table-cell border border-border font-semibold text-blue-500 px-2 py-1"
              {...props}
            >
              {children}
            </th>
        ...
        p({ children, ...props }) {
          ...
          if (typeof children === "string") {
            ...
            const jsonObject = tryParseJson(stringChildren);
