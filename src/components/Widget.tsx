import { AiChat, ChatAdapter, StreamingAdapterObserver, ChatItem, PersonaOptions, AiChatProps } from '@nlux/react';
...
export default function Widget(props: WidgetProps) {
  ...
  const conversationOptions = advancedOptions.conversationOptions || { layout: 'bubbles' };
  const displayOptions = advancedOptions.displayOptions || { colorScheme: "dark" };
  const composerOptions = advancedOptions.composerOptions || { placeholder: "How can i help you today ?" };
  console.log(conversationOptions);
  return (
    <main className="flex items-center justify-between" style={props.style || {}}>
      <AiChat
        adapter={chatAdapter}
